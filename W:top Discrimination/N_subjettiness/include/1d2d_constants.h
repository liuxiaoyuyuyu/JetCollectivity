...
const int   trackbinbounds[trackbin]         = { 0,20,30,40,50,60,70,80,90};
const int   trackbinboundsUpper[trackbin]    = {20,30,40,50,60,70,80,90,120};
...
const int sdRg_bin=2;
double sdRg_low[sdRg_bin] ={0.0,0.3 };
double sdRg_high[sdRg_bin]={0.3,1.0 };


//cut mode=3:cut on Zg(Rg/R)^{beta}=Zg(Theta_g)^{beta}, (here ,Theta_g is defined as :Theta_g=Rg/R and R=0.8 as above )
const int sdZgTgB_bin=2;
double sdZgTgB_low[sdZgTgB_bin]={0.00,0.05};
double sdZgTgB_high[sdZgTgB_bin]={0.05,1.00};
