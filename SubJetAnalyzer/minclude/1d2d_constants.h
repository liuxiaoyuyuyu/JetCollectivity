...
const int trackbinbounds[trackbin]=     {0, 20,30,40,50,60,70,80,90,100};
const int trackbinboundsUpper[trackbin]={20,30,40,50,60,70,80,90,100,120};
...
const double beta_SD[beta_bin]={2.0,1.0,0.0};


//softDrop Zg
const int sdZg_bin                          = 1;
const float sdZg_lo[sdZg_bin]={-100};
const float sdZg_hi[sdZg_bin]={100};



//softDrop Rg
const int sdRg_bin                          = 1;
const float sdRg_lo[sdRg_bin]={-100};
const float sdRg_hi[sdRg_bin]={100};
//softDrop Zg(Theta_g)^{beta}
const int sdZgTg_bin                          = 1;
const float sdZgTg_lo[sdZgTg_bin]={-100};
const float sdZgTg_hi[sdZgTg_bin]={100};
